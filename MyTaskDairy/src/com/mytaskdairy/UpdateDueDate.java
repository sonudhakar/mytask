...
public class UpdateDueDate extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,
		...
		Token tg=(Token)ss.getAttribute("access");
	
		OAuthRequest reque = new OAuthRequest(Verb.PUT, "https://trello.com/1/cards/"+request.getParameter("cardid")+"/due?value="+request.getParameter("datetext")+"&key=d55c5a0e967be02e36d29ad80c5d6adb");
		
		sService.signRequest(tg, reque);
